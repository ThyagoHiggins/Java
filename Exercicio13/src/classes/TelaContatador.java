...
public class TelaContatador extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaContatador
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaContatador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaContatador().setVisible(true);
            }
        });
    }
